...
if(isset($_POST['validate'])){
    ...
    if(!empty($_POST['title']) AND !empty($_POST['description']) AND !empty($_POST['content'])){
        ...
        //Modifier les information de la question qui possède l'id rentré en paramètre dans l'URL
        ...
        //Redirection vers la page d'affiche des questions de l'utilisateur
